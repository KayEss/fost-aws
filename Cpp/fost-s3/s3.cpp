...
namespace {
    fostlib::nullable<fostlib::string> etag(const fostlib::fs::path &file) {
...
const fostlib::setting<fostlib::string> fostlib::aws::s3::bucket::s_account_name(
...
namespace {
    auto
            s3do(const fostlib::http::user_agent &ua,
    ...
    fostlib::url base_url(const fostlib::ascii_printable_string &bucket) {
...
fostlib::url fostlib::aws::s3::bucket::uri(const fs::path &location) const {
    return url(
            m_ua.base(),
...
fostlib::aws::s3::file_info
        fostlib::aws::s3::bucket::stat(const fs::path &location) const {
    return file_info(m_ua, name(), location);
}


fostlib::string fostlib::aws::s3::bucket::get(const fs::path &location) const {
...
fostlib::aws::s3::outcome fostlib::aws::s3::bucket::get(
        const fs::path &location, const fs::wpath &file) const {
...
namespace {
    fostlib::aws::s3::outcome
            do_put(const fostlib::aws::s3::bucket &bucket,
                   const fostlib::http::user_agent &ua,
                   const fostlib::string &hash,
                   const fostlib::fs::path &location,
                   fostlib::http::user_agent::request &request) {
...
fostlib::aws::s3::outcome fostlib::aws::s3::bucket::put(
        ...
        const fostlib::fs::path &location) const {
    fostlib::nullable<fostlib::string> local(etag(file));
    if (not local) {
...
fostlib::aws::s3::outcome fostlib::aws::s3::bucket::put(
        const fostlib::string &text, const fostlib::fs::path &location) const {
